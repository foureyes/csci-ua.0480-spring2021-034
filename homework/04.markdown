...
In `urlShortener.js`, create a class that represents a URL Shortener. The main logic to shorten the URL should be included in this class. Your class should behave as follows:
